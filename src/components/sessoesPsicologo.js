            ...
            <div className="modal d-block" tabIndex="-1" role="dialog" style={{ background:'rgba(0,0,0,0.35)' }}>
              <div className="modal-dialog" role="document">
                <div className="modal-content">
                  ...
                  <div className="modal-footer">
                    <button className="btn btn-secondary" onClick={()=>setShowReagendar(false)}>Fechar</button>
                    <button className="btn btn-success" onClick={reagendarAgendamento} disabled={!novaHora || loadingReagendar}>
                      {loadingReagendar ? 'A reagendar…' : 'Confirmar'}
                    </button>
                  </div>
                </div>
